...
import com.healthbank.adapter.Explistadapterotherreport;
...
public class CategorisedotherReportActivity extends ActivityCommon {

    ExpandableListView expListView;
    Explistadapterotherreport listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_categorisedother_report);
        setmaterialDesign();
        back();
        expListView = findViewById(R.id.explist);
        prepareListData();
        listAdapter = new Explistadapterotherreport(this, listDataHeader, listDataChild);
    ...
    private void prepareListData() {
        ...
        // Adding child data
        listDataHeader.add("22 Jun 2018");
        listDataHeader.add("18 Jun 2018");
        listDataHeader.add("17 Jun 2018");
        ...
        nowShowing.add("Report2");
        nowShowing.add("Report2");
        nowShowing.add("Report2");
        nowShowing.add("Report2");

        List<String> comingSoon = new ArrayList<String>();
        comingSoon.add("Report3");
        comingSoon.add("Report3");
        comingSoon.add("Report3");
        comingSoon.add("Report3");
    ...
    public void SelectFile() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(CategorisedotherReportActivity.this);
            ...
            switch (requestCode) {
                ...
                case 900:
                    try {
                        ...
                        Log.e("name ","name "+sourcefile.getPath()+" "+Destfile.getPath()+" "+sourcefile.getName());
                        copyFile(sourcefile, Destfile);
                        listDataChild.get(this.listDataHeader.get(0)).add(sourcefile.getName());
                ...
                case 100:
                    ...
                    if (uriString.startsWith("content://")) {
                        ...
                        if (uri.getScheme().compareTo("content") == 0) {
                            ...
                            Cursor cursor11= CategorisedotherReportActivity.this.getContentResolver().query(uri, filePathColumn, null, null, null);
                            ...
                            String[] projection1 = {MediaStore.Images.Media.DATA};
                            Cursor  cursor1 = CategorisedotherReportActivity.this.getContentResolver().query(uri1, null, null, null, null);
