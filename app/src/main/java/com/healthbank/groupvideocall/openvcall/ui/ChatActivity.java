...
import com.healthbank.groupvideocall.openvcall.model.AGEventHandler;
...
import com.healthbank.groupvideocall.openvcall.model.User;
import com.healthbank.groupvideocall.propeller.Constant;
import com.healthbank.groupvideocall.propeller.UserStatusData;
import com.healthbank.groupvideocall.propeller.VideoInfoData;
import com.healthbank.groupvideocall.propeller.preprocessing.VideoPreProcessing;
import com.healthbank.groupvideocall.propeller.ui.RtlLinearLayoutManager;
...
/*import videoagora.com.groupchatagora.R;
import videoagora.com.groupchatagora.openvcall.model.AGEventHandler;
import videoagora.com.groupchatagora.openvcall.model.ConstantApp;
import videoagora.com.groupchatagora.openvcall.model.Message;
import videoagora.com.groupchatagora.openvcall.model.User;
import videoagora.com.groupchatagora.propeller.Constant;
import videoagora.com.groupchatagora.propeller.UserStatusData;
import videoagora.com.groupchatagora.propeller.VideoInfoData;
import videoagora.com.groupchatagora.propeller.preprocessing.VideoPreProcessing;
import videoagora.com.groupchatagora.propeller.ui.RtlLinearLayoutManager;*/
...
public class ChatActivity extends BaseActivity implements AGEventHandler {
    ...
    private void sendChannelMsg(String msgStr) {
        ...
        byte[] encodedMsg;
        encodedMsg = msgStr.getBytes(StandardCharsets.UTF_8);
        //  Log.e("msg ","msg "+msgStr+"\n"+encodedMsg);
    ...
    private void showMessageEditContainer() {
        ...
        EditText edit = findViewById(R.id.msg_content);
