...
public class MainActivity extends BaseActivity {
    ...
    protected void initUIandEvent() {
        ...
        Spinner encryptionSpinner = findViewById(R.id.encryption_mode);
    ...
    public void forwardToRoom() {
        ...
        Log.e("channel ",channel+" "+encryption+" "+ getResources().getStringArray(R.array.encryption_mode_values)[vSettings().mEncryptionModeIndex]);
        Log.e("data ",vSettings().mChannelName+" "+vSettings().mEncryptionKey+" "+vSettings().mEncryptionModeIndex);
