...
public class BloodReportAdpater extends RecyclerView.Adapter<BloodReportAdpater.viewHolder> {
    Context mContext;
    ArrayList<String> mdataset;

    public BloodReportAdpater(Context mContext, ArrayList<String> mdataset) {
    ...
    public void onBindViewHolder(viewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((ActivityCommon) mContext).gototableactivity();
            }
        });
    }
